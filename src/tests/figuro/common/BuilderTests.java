...
public class BuilderTests {
	...
	public void testGetGameTypes() {
		...
		assertTrue("Game type incorrect",
				builder.getGameTypes()[0].equals("game.checkers"));
	}
	...
	public void testCreateGame_Checkers() {
		...
		assertTrue("Game checkers creation incorrect",
				g1.getClass().equals(Checkers.class));
	}
	...
	public void testCreatePlayer_UIPlayer() {
		...
		assertTrue("PlayerUI creation incorrect",
				p_ui.getClass().equals(UIPlayer.class));
	}
	...
	public void testCreatePlayer_NetPlayer() {
		...
		assertTrue("NetPlayer creation incorrect",
				p_net.getClass().equals(NetPlayer.class));
	}
	...
	public void testCreatePlayer_AlphabetaPlayer() {
		...
		assertTrue("BotPlayer creation incorrect", p_alphabeta.getClass()
				.equals(BotPlayer.class));
	}
