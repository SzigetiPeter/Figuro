...
public class CheckersEvaluator implements IStepEvaluator {
    ...
    public Evaluation getMinimum() {
    	int lowestScore = 0;
        Evaluation evaluation = new Evaluation(0, lowestScore);
    	return evaluation;
    }
    
    @Override
    public Evaluation getMaximum() {
        int highestScore = 36; // = 12 puppet * 3 points (all puppets are KING)
        Evaluation evaluation = new Evaluation(0, highestScore);
    	return evaluation;
    }
}
