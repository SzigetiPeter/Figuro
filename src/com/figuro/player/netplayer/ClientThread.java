...
public class ClientThread extends Thread {
	...
	public ClientThread(IThreadDelegate delegate, String ipString, int portNumber, SetupDialog dialog) {
		mIpString = ipString;
		...
		try {
			...
			Platform.runLater(new Runnable() {
				...
				public void run() {
					...
					System.out.println("Created socket " + mSocket.getInetAddress().getHostAddress() + " port " + mSocket.getPort());
